-- Migration: revert_import_function_to_returning
-- Descripción: Revierte la función import_survey_from_json para usar RETURNING id INTO variable

-- Eliminar la función existente para evitar conflictos
DROP FUNCTION IF EXISTS public.import_survey_from_json(jsonb);

-- Crear la función para importar encuestas desde JSON usando RETURNING
...
BEGIN
    ...
    -- Insertar la encuesta usando RETURNING
    ...
    IF survey_data -> 'sections' IS NOT NULL THEN
        ...
        LOOP
            ...
            -- Insertar la sección usando RETURNING
            ...
            IF section_json -> 'questions' IS NOT NULL THEN
                ...
                LOOP
                    ...
                    -- Insertar la pregunta (sin RETURNING, no necesitamos el ID)
